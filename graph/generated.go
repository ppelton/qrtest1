...
) (model.ItemInput, error) {
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNItemInput2qrtest1ᚗpeltoniumᚗnetᚋgraphᚋmodelᚐItemInput(ctx, tmp)
	}

	var zeroVal model.ItemInput
	return zeroVal, nil
}
...
func (ec *executionContext) _Mutation_createItem(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNItem2ᚖqrtest1ᚗpeltoniumᚗnetᚋgraphᚋmodelᚐItem(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_items(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Item)
	fc.Result = res
	return ec.marshalNItem2ᚕᚖqrtest1ᚗpeltoniumᚗnetᚋgraphᚋmodelᚐItemᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNItem2qrtest1ᚗpeltoniumᚗnetᚋgraphᚋmodelᚐItem(ctx context.Context, sel ast.SelectionSet, v model.Item) graphql.Marshaler {
	return ec._Item(ctx, sel, &v)
}

func (ec *executionContext) marshalNItem2ᚕᚖqrtest1ᚗpeltoniumᚗnetᚋgraphᚋmodelᚐItemᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Item) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNItem2ᚖqrtest1ᚗpeltoniumᚗnetᚋgraphᚋmodelᚐItem(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNItem2ᚖqrtest1ᚗpeltoniumᚗnetᚋgraphᚋmodelᚐItem(ctx context.Context, sel ast.SelectionSet, v *model.Item) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNItemInput2qrtest1ᚗpeltoniumᚗnetᚋgraphᚋmodelᚐItemInput(ctx context.Context, v any) (model.ItemInput, error) {
